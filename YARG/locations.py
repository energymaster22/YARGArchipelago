...
def create_regular_locations(world: YARGWorld) -> None:
    ...
    #bottom_left_chest = YARGLocation(
    ...
    #)
    #bottom_right_room.add_locations(bottom_right_room_locations, YARGLocation)

    #top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    #top_left_room.add_locations(top_left_room_locations, YARGLocation)

    #right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    #right_room.add_locations(right_room_locations, YARGLocation)
    ...
    #    top_middle_room.add_locations(top_middle_room_locations, YARGLocation)
    #else:
    #    overworld.add_locations(top_middle_room_locations, YARGLocation)
    ...
    # In our case, the extra_starting_chest option adds the Bottom Left Extra Chest location.
        ...
        #overworld.add_locations(bottom_left_extra_chest, YARGLocation)


#def create_events(world: YARGWorld) -> None:
    ...
    #button_in_top_left_room = YARGLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    #button_item = items YARGItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
    ...
    #    "Final Boss Defeated", "Victory", location_type YARGLocation, item_type=items YARGItem
    #)
